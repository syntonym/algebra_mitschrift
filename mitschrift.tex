...
$\Rightleftarrow$ alle $\alpha \in L$ sind algebraisch �ber $K$.
...
\subsection{Beweis}
\begin{enumerate}[]
\item[$(1) \Rightarrow (2)$] a algebraisch �ber K $\Rightleftarrow \exists P \in K[x], P \neq 0$
mit $P(a) = 0 \Rightleftarrow \varepsilon_a$ nicht injektiv.
