...
\maketitle
%\tableofcontents
%TODO Sinnvolle Gliederung fÃ¼r den Inhalt (welche Sachen werden in das Inhaltsverzeichnis aufgenommen)
...
\section{Bemerkung:}
%TODO Besser formatieren (AbsÃ¤tze)
...
\section{Beweis}
%TODO Der Beweis ist schlecht formatiert. Insb. Einr"uckungen, AbsÃ¤tze und AbstÃ¤nde
%TODO Latexzeichen fÃ¼r := und =: einsetzen
...
\section{Beispiel:}
%TODO irgendwie unvollstÃ¤ndig oder nicht so sehr verstÃ¤ndlich?
...
%TODO hier kommutatives Diagramm einfÃ¼gen
...
\end{enumerate}
\section{Definition}
%TODO <s> besser machen (< und > nÃ¤her an s)
...
Falls $H \neq \{0\}$, so enthÃ¤lt %hier fehlt was%
...
\subsection{Beispiele}
%TODO Formatierung hiervon evtl schÃ¶ner machen?
...
Beweis
Ist $d = deg(P)$, so ist $L \cong K \bigoplus K \bar{x} \bigoplus ... \bigoplus K \bar{x}^{d-1}$
